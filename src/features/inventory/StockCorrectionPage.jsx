...
export default function StockCorrectionPage() {
    const { t } = useLanguage();
    const emptyRow = (id) => ({
        id, code: "", productName: "", batchCode: "",
        expiryDate: "", quantity: "", price: "", total: "",
    });
    ...
    return (<div className="space-y-4">
      ...
      <div className="pos-summary-bar">
        ...
        <div className="pos-summary-cell pos-summary-cell-value text-sm"></div>
        <div className="pos-summary-cell pos-summary-cell-value text-sm hidden md:block"></div>
        <div className="pos-summary-cell pos-summary-cell-value text-sm hidden md:block"></div>
      </div>
